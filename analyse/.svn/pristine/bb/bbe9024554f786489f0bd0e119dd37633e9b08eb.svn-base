...
public class DateUtils {
	...
	public static String formatDate(Date date){
		String dateString = getDateString(date, "yyyy-MM-dd HH:mm:ss");
		if(dateString == null)
			dateString = "";
		return dateString;
	}
	 ...
	 * @param timeLong 离January 1, 1970, 00:00:00 GMT的秒数
	 * @return 当前时间字符串
	 */
	...
	/**
	 * 获取与时间<code>dateTime</code>距离<code>second</code>秒的时间
	 * dateTime形如yyyy-MM-dd HH:mm:ss
	 * @param dateTime
	 * @param second
	 * @return
	 */
	...
	public static boolean isTodayLastOfMonth(){
        return getCurrentDayOfMonth() == getDayNumOfMonth(getCurrentYear(), getCurrentMonth());
	}
	 ...
	 * @param startTime
	 * @param endTime
	 * @param format 返回的列表每项的格式
	 * @return 
	 * @throws Exception
	 */
	public static List<String> getAllMonthBetween(String startTime, String endTime, String format) {
